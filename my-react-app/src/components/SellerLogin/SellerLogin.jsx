  ...
  return !isSeller &&  (
    <form onSubmit={onSubmitHandler} className="min-h-screen flex items-center text-sm text-gray-600">
        ...
        rounded-lg shadow-xl border border-gray-200 '>
            <p className="text-2xl  font-medium m-auto"><span className='text-primary'>Login</span></p>
            <div className='w-full'>
                <p>Email</p>
                <input
                onChange={(e) => setEmail(e.target.value)} value={email}
                 type='email' placeholder='Enter email'
                    className='border broder-gray-200 rounded w-full  p-2  mt-1  outline-primary' required
                />
            </div>
            <div className='w-full'>
                <p>Password</p>
          ...
          <button
            ...
            setPassword("Seller123");
                    ...
                    className='text-blue hover:underline text-center w-full'
                >
                    Use Dummy Seller Data
                </button>
