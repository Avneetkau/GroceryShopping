...
const AddProducts = () => {
  ...
  return (
    <div class Name="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        <input
                        onChange={(e) =>setPrice(e.target.value)} value={price} id="product-price" type="number" 
                ...
                <button className="px-8 py-2.5 cursor-pointer  bg-primary w-full text-white font-medium rounded hover:bg-primary-dull">ADD</button>
            </form>
        </div>
  )
}
